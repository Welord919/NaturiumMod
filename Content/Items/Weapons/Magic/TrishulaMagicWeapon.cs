...
namespace NaturiumMod.Content.Items.Weapons.Magic
{
    public class TrishulaWeapon : ModItem
    {
        public override string Texture => "NaturiumMod/Assets/Items/IceBarrier/TrishulaWeapon";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/IceBarrier/TrishulaProj";
