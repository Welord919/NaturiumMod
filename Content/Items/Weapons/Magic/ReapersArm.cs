...
namespace NaturiumMod.Content.Items.Weapons.Magic
{
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Weapons/ReapersArm";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Projectiles/SpiritScytheProj";
