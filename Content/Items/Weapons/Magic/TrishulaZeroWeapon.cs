...
namespace NaturiumMod.Content.Items.Weapons.Magic
{
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Weapons/TrishulaZeroWeapon";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Projectiles/TrishulaZeroProj";
