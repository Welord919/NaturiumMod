...
namespace NaturiumMod.Content.Items.Weapons.Ranged
{
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Shark/SharkDrake";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Shark/SpiderShark";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Shark/AeroShark";
