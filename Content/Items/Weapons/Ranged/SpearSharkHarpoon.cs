...
namespace NaturiumMod.Content.Items.Weapons.Ranged
{
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Shark/SpearSharkHarpoon";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Shark/SpearSharkHarpoonProj";
