...
namespace NaturiumMod.Content.Items.Weapons.Summoner
{
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/IceBarrier/IceBarrierWhip";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/IceBarrier/IceBarrierWhipProj";
