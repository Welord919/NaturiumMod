...
namespace ModdingGang.Content.Items.Consumables
{
    public class MktPotion : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<NaturiumOre>(), 4);
            recipe.AddIngredient(ModContent.ItemType<CameliaPetal>(), 2);
