...
namespace NaturiumMod.Content.Items.Accessories
{
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Millennium/MillenniumNecklace";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/Items/Millennium/MillenniumVileEye";
        ...
        {
            public override string Texture => "NaturiumMod/Assets/Items/Millennium/MillenniumVilethorn";
            public override void SetStaticDefaults()
            {
