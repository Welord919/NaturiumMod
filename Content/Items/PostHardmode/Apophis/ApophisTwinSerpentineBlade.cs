...
using NaturiumMod.Content.Items.Hardmode.ApophisItems;
...
namespace NaturiumMod.Content.Items.PostHardmode.Apophis;

public class ApophisTwinSerpentineBlade : ModItem
{
    private int chargeTimer;

    public override string Texture => "NaturiumMod/Assets/Items/PreHardmode/Apophis/ApophisTwinSerpentineBlade";
