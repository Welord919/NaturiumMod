...
{
    private int helixCharge = 0; // 0 = wide, 60 = tight

    public override string Texture => "NaturiumMod/Assets/Items/PostHardmode/Weapons/EclipseTwinShooter";
