...
{
    public class NaturiumChestTile : ModTile
    {
        public override string Texture => "NaturiumMod/Assets/Tiles/NaturiumChestTile";
        ...
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<Items.General.Placeable.NaturiumChest>(), 1);
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    ...
                    int key = ModContent.ItemType<NaturiumKey>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<NaturiumChest>();
                    if (Main.tile[left, top].TileFrameX / 36 == 1)
                    {
                        player.cursorItemIconID = ModContent.ItemType<NaturiumKey>();
                    }
