...
namespace NaturiumMod.Content.NPCs.Enemies
{
    ...
    internal class PlagueWormHead : WormHead
    {
        ...
        {
            public override string Texture => "NaturiumMod/Assets/Tiles/PlagueWormHeadBanner";
            public override void SetDefaults()
            {
        ...
        {
            public override string Texture => "NaturiumMod/Assets/Projectiles/PlagueBlobProj";
