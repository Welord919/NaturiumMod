...
namespace NaturiumMod.Content.NPCs.Enemies;



public class RightHandSharkNPC : ModNPC
{
    public override string Texture => "NaturiumMod/Assets/Items/Shark/RightHandSharkNPC";
...
{
    public override string Texture => "NaturiumMod/Assets/Items/Shark/SharkGore1";
}
public class SharkGore2 : ModGore
{
    public override string Texture => "NaturiumMod/Assets/Items/Shark/SharkGore2";
}
public class SharkGore3 : ModGore
{
    public override string Texture => "NaturiumMod/Assets/Items/Shark/SharkGore3";
}
public class SharkGore4 : ModGore
{
    public override string Texture => "NaturiumMod/Assets/Items/Shark/SharkGore4";
}
