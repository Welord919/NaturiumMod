...
using static NaturiumMod.Content.NPCs.TownNPCS.MGHelpers;
using static NaturiumMod.Content.NPCs.TownNPCS.MysteriousGrandpa;

namespace NaturiumMod.Content.NPCs.TownNPCS;
    ...
    public static bool TryComplete(Player player)
    {
        switch (CardQuestWorld.questStage)
        {
            ...
            case 7:
                ...
                {
                    ConsumeItem(player, ModContent.ItemType<PlaguespreaderCard>(), 1);
