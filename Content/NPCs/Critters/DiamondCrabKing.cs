...
namespace NaturiumMod.Content.NPCs.Critters
{
    ...
    {
        public override string Texture => "NaturiumMod/Assets/NPCs/DiamondCrabKing";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/NPCs/DiamondCrabKingSprite";
    ...
    {
        public override string Texture => "NaturiumMod/Assets/NPCs/DCKGore1";
    }
    public class DiamondCrabKingGore2 : ModGore
    {
        public override string Texture => "NaturiumMod/Assets/NPCs/DCKGore2";
    }
